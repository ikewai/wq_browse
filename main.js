...
let MapComponent = class MapComponent {
    ...
    tableSearch(term) {
        if (!term) {
            ...
            this.filterData = this.metadata.filter(x => x.value.forEach(obj => {
