...
let AppConfig = AppConfig_1 = class AppConfig {
    ...
    load() {
        const jsonFile = `assets/config/config.${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].name}.json`;
...
let FilterManagerService = class FilterManagerService {
    constructor() {
    ...
    registerFilter(conditions, sorter) {
    ...
    setFilterSorter(handle, sortFunction) {
...
let QueryCacheService = QueryCacheService_1 = class QueryCacheService {
    ...
    createEntry(key, initData, options) {
        let initOptions = {
...
let QueryHandlerService = QueryHandlerService_1 = class QueryHandlerService {
    constructor(spatial, cache, filters) {
        ...
        this.query = function* (query, startPoint) {
            let ramp = QueryHandlerService_1.RAMP_FUNCT(startPoint);
    ...
    handleQuery(query) {
        let dataStream = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]({ status: null, data: [] });
        let stored = this.cache.fetchData(query);
        let offset;
        let complete;
        if (stored == null) {
            offset = 0;
        ...
        if (!complete) {
            ...
            let controllerSub = dataController.data.subscribe((data) => {
    ...
    requestDriver(query, offset) {
        let dataStream = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    recursivePromise(promise, handler) {
        promise.then((data) => {
            handler(data);
        });
    }
...
QueryHandlerService.RAMP_FUNCT = QueryHandlerService_1.ENABLE_FAST_QUERY ? function* (start) {
    let acc = start;
    let size = QueryHandlerService_1.MIN_QUERY;
...
class QueryController {
    constructor(querySubjects) {
        ...
        for (i = 0; i < querySubjects.length; i++) {
            querySubjects[i].subscribe((response) => {
...
let SpatialService = class SpatialService {
    ...
    search(query, limit, offset) {
        ...
        let url = _config_service__WEBPACK_IMPORTED_MODULE_5__["AppConfig"].settings.aad.tenant + "/search/v2/data?q=" + encodeURI(query) + "&limit=" + limit.toString() + "&offset=" + offset.toString();
        ...
        let head = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]()
        ...
        let response = this.http.get(url, options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((data) => {
            return data.body.result;
...
/* harmony import */ var _services_config_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./_services/config.service */ "./src/app/_services/config.service.ts");
...
/* harmony import */ var _asymmetrik_ngx_leaflet_draw__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @asymmetrik/ngx-leaflet-draw */ "./node_modules/@asymmetrik/ngx-leaflet-draw/dist/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _asymmetrik_ngx_leaflet_draw__WEBPACK_IMPORTED_MODULE_14__["LeafletDrawModule"].forRoot()
        ],
        providers: [
            _services_config_service__WEBPACK_IMPORTED_MODULE_12__["AppConfig"],
            { provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["APP_INITIALIZER"],
                useFactory: initializeApp,
                deps: [_services_config_service__WEBPACK_IMPORTED_MODULE_12__["AppConfig"]], multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HTTP_INTERCEPTORS"], useClass: _helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_8__["JwtInterceptor"], multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HTTP_INTERCEPTORS"], useClass: _helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_9__["ErrorInterceptor"], multi: true },
        ],
...
module.exports = "<h3>Search Hawai‘i Water Quality Sites</h3>\r\nUse the bounding tools on the left to create a bounding area to search\r\n<app-map></app-map>\r\n<div>\r\n</div>\r\n"
...
module.exports = "\r\n.map {\r\n    width: 100%;\r\n    height: 500px;\r\n}\r\n\r\n::ng-deep .marker-cluster-small-sites {\r\n    background-color: rgba(252,146,114, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-small-sites div {\r\n    background-color: rgba(251,106,74, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-medium-sites {\r\n    background-color: rgba(239,59,44, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-medium-sites div {\r\n    background-color: rgba(203,24,29, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-large-sites {\r\n    background-color: rgba(165,15,21, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-large-sites div {\r\n    background-color: rgba(103,0,13, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-small-wells {\r\n    background-color: rgba(158, 202, 225, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-small-wells div {\r\n    background-color: rgba(107, 174, 214, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-medium-wells {\r\n    background-color: rgba(66, 146, 198, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-medium-wells div {\r\n    background-color: rgba(33, 113, 181, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-large-wells {\r\n    background-color: rgba(8, 81, 156, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-large-wells div {\r\n    background-color: rgba(8, 48, 107, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-small-waterQualitySites {\r\n    background-color: rgba(161,217,155, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-small-waterQualitySites div {\r\n    background-color: rgba(116,196,118, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-medium-waterQualitySites {\r\n    background-color: rgba(65,171,93, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-medium-waterQualitySites div {\r\n    background-color: rgba(35,139,69, 0.8) !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-large-waterQualitySites {\r\n    background-color: rgba(0,109,44, 0.8) !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .marker-cluster-large-waterQualitySites div {\r\n    background-color: rgba(0,68,27, 0.8) !important;\r\n}\r\n\r\n::ng-deep .entry-link {\r\n    color: #0000EE;\r\n    text-decoration: underline;\r\n    cursor: pointer;\r\n    z-index: 10000;\r\n}\r\n\r\n.highlight {\r\n    background-color: #ccff00;\r\n}\r\n\r\n::ng-deep .grid {\r\n    display: grid;\r\n    grid-template-areas:\r\n    \"bl bl bl ht ht ht ht\"\r\n    \"bl bl bl s1 s2 s2 s3\"\r\n    \"hl t1 t1 c1 c2 c2 c3\"\r\n    \"hl t2 t2 c4 c5 c5 c6\"\r\n    \"hl t3 t3 c7 c8 c8 c9\";\r\n    grid-gap: 1px;\r\n    padding: 5px 20px 5px 5px;\r\n    width: 200px;\r\n    height: 125px;\r\n    border-radius: 10%;\r\n    /* grid-auto-rows: 6%;\r\n    grid-auto-columns: 8%; */\r\n    grid-auto-rows: 16%;\r\n    grid-auto-columns: 14%;\r\n    background-color: rgba(0, 0, 0, 0.15);\r\n    text-shadow: -1px 0 5px white, 0 1px 5px white,\r\n    1px 0 5px white, 0 -1px 5px white;\r\n    font-weight: bold;\r\n    color: black;\r\n}\r\n\r\n::ng-deep .grid > div {\r\n    /* background-color: rgba(255, 255, 255, 0.8); */\r\n    text-align: center;\r\n    line-height: 12px;\r\n    padding: 0px;\r\n    font-size: 14px;\r\n    /* width: 70px;\r\n    height: 70px; */\r\n}\r\n\r\n::ng-deep .color-circle {\r\n    border-radius: 50%;\r\n    height: 14px;\r\n    width: 14px;\r\n    margin: 0 auto;\r\n    box-shadow: -1px 0 5px white, 0 1px 5px white,\r\n    1px 0 5px white, 0 -1px 5px white;\r\n}\r\n\r\n::ng-deep .color-1 {\r\n    background-color: rgba(107, 174, 214,1);\r\n}\r\n\r\n::ng-deep .color-2 {\r\n    background-color: rgba(33, 113, 181, 1);\r\n}\r\n\r\n::ng-deep .color-3 {\r\n    background-color: rgba(8, 48, 107, 1)\r\n}\r\n\r\n::ng-deep .color-4 {\r\n    background-color: rgba(251,106,74, 1);\r\n}\r\n\r\n::ng-deep .color-5 {\r\n    background-color: rgba(203,24,29, 1);\r\n}\r\n\r\n::ng-deep .color-6 {\r\n    background-color: rgba(103,0,13, 1);\r\n}\r\n\r\n::ng-deep .color-7 {\r\n    background-color: rgba(116,196,118, 1);\r\n}\r\n\r\n::ng-deep .color-8 {\r\n    background-color: rgba(35,139,69, 1);\r\n}\r\n\r\n::ng-deep .color-9 {\r\n    background-color: rgba(0,68,27, 1);\r\n}\r\n\r\n::ng-deep .bl {\r\n    grid-area: bl;\r\n    font-size: 16px !important;\r\n    text-shadow: -1px 0 5px black, 0 1px 5px black,\r\n    1px 0 5px black, 0 -1px 5px black !important;\r\n    color: white !important;\r\n}\r\n\r\n::ng-deep .ht {\r\n    grid-area: ht;\r\n}\r\n\r\n::ng-deep .hl {\r\n    grid-area: hl;\r\n    -webkit-writing-mode: vertical-rl;\r\n        -ms-writing-mode: tb-rl;\r\n            writing-mode: vertical-rl;\r\n}\r\n\r\n::ng-deep .t1 {\r\n    grid-area: t1;\r\n}\r\n\r\n::ng-deep .t2 {\r\n    grid-area: t2;\r\n}\r\n\r\n::ng-deep .t3 {\r\n    grid-area: t3;\r\n}\r\n\r\n::ng-deep .s1 {\r\n    grid-area: s1;\r\n}\r\n\r\n::ng-deep .s2 {\r\n    grid-area: s2;\r\n}\r\n\r\n::ng-deep .s3 {\r\n    grid-area: s3;\r\n}\r\n\r\n::ng-deep .c1 {\r\n    grid-area: c1;\r\n}\r\n\r\n::ng-deep .c2 {\r\n    grid-area: c2;\r\n}\r\n\r\n::ng-deep .c3 {\r\n    grid-area: c3;\r\n}\r\n\r\n::ng-deep .c4 {\r\n    grid-area: c4;\r\n}\r\n\r\n::ng-deep .c5 {\r\n    grid-area: c5;\r\n}\r\n\r\n::ng-deep .c6 {\r\n    grid-area: c6;\r\n}\r\n\r\n::ng-deep .c7 {\r\n    grid-area: c7;\r\n    margin-top: 15px;\r\n}\r\n\r\n::ng-deep .c8 {\r\n    grid-area: c8;\r\n    margin-top: 15px;\r\n}\r\n\r\n::ng-deep .c9 {\r\n    grid-area: c9;\r\n    margin-top: 15px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _services_config_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_services/config.service */ "./src/app/_services/config.service.ts");
/* harmony import */ var _services_query_handler_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../_services/query-handler.service */ "./src/app/_services/query-handler.service.ts");
/* harmony import */ var _services_filter_manager_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../_services/filter-manager.service */ "./src/app/_services/filter-manager.service.ts");
...
let MapComponent = class MapComponent {
    constructor(renderer, queryHandler, filters, http) {
        ...
        this.options = {
            layers: [
                ...
                Object(leaflet__WEBPACK_IMPORTED_MODULE_3__["tileLayer"])('http://www.google.com/maps/vt?lyrs=y@189&gl=en&x={x}&y={y}&z={z}', { maxZoom: 18, attribution: '...' })
            ],
            zoom: 6,
            center: Object(leaflet__WEBPACK_IMPORTED_MODULE_3__["latLng"])(20.5, -157.917480),
            attributionControl: false
        };
        this.drawnItems = new leaflet__WEBPACK_IMPORTED_MODULE_3__["FeatureGroup"];
        this.drawOptions = {
            position: 'topleft',
            draw: {
                polyline: false,
    ...
    onMapReady(map) {
        this.metadata = [];
        this.map = map;
        let legendControl = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Control"]({ position: "bottomleft" });
        legendControl.onAdd = (map) => {
            let legend = leaflet__WEBPACK_IMPORTED_MODULE_3__["DomUtil"].create("div", "legend");
        ...
        let iconCreateFunction = (group) => {
            return (cluster) => {
                ...
                return new leaflet__WEBPACK_IMPORTED_MODULE_3__["DivIcon"]({ html: '<div><span>' + childCount + '</span></div>',
                    className: markerClass, iconSize: new leaflet__WEBPACK_IMPORTED_MODULE_3__["Point"](40, 40) });
            };
        };
        this.dataGroups = {
            sites: leaflet__WEBPACK_IMPORTED_MODULE_3__["markerClusterGroup"]({ iconCreateFunction: iconCreateFunction("sites") }),
            wells: leaflet__WEBPACK_IMPORTED_MODULE_3__["markerClusterGroup"]({ iconCreateFunction: iconCreateFunction("wells") }),
            waterQualitySites: leaflet__WEBPACK_IMPORTED_MODULE_3__["markerClusterGroup"]({ iconCreateFunction: iconCreateFunction("waterQualitySites") })
        };
        let controlGroups = {};
        ...
        leaflet__WEBPACK_IMPORTED_MODULE_3__["control"].layers(null, controlGroups).addTo(this.map);
    ...
    createPostit(file_url) {
        let url = _services_config_service__WEBPACK_IMPORTED_MODULE_5__["AppConfig"].settings.aad.tenant + "/postits/v2/?url=" + encodeURI(file_url) + "&method=GET&lifetime=600&maxUses=1";
        let head = new _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpHeaders"]()
            .set("Content-Type", "application/x-www-form-urlencoded");
        ...
        console.log(url);
        return this.http.post(url, {}, options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((response) => response));
    }
    tableSearch(term) {
        if (!term) {
    ...
    onDrawCreated(e) {
        ...
        let dataStream = this.queryHandler.spatialSearch([e.layer.toGeoJSON()]);
        ...
        dataStream.getQueryObserver().subscribe((data) => {
            data = data.data;
            //data;
            if (data == null) {
                return;
            ...
            for (i = 0; i < indices.length; i++) {
                ...
                let group = NameGroupMap[datum.name];
                //console.log(datum.value.loc);
                let geojson = leaflet__WEBPACK_IMPORTED_MODULE_3__["geoJSON"](datum.value.loc, {
                    style: this.getStyleByGroup(group),
                    pointToLayer: (feature, latlng) => {
                        let icon = this.getIconByGroup(group);
                        return leaflet__WEBPACK_IMPORTED_MODULE_3__["marker"](latlng, { icon: icon });
                    },
                    onEachFeature: (feature, layer) => {
                        let header = leaflet__WEBPACK_IMPORTED_MODULE_3__["DomUtil"].create("h6");
                        let wrapper = leaflet__WEBPACK_IMPORTED_MODULE_3__["DomUtil"].create("div");
                        let details = leaflet__WEBPACK_IMPORTED_MODULE_3__["DomUtil"].create("div");
                        let download = leaflet__WEBPACK_IMPORTED_MODULE_3__["DomUtil"].create("div");
                        ...
                        let popup = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Popup"]();
    ...
    getIconByGroup(group) {
        let icon;
        switch (group) {
            case "waterQualitySites": {
                icon = new leaflet__WEBPACK_IMPORTED_MODULE_3__["Icon"]({
...
MapComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _services_query_handler_service__WEBPACK_IMPORTED_MODULE_6__["QueryHandlerService"], _services_filter_manager_service__WEBPACK_IMPORTED_MODULE_7__["FilterManagerService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClient"]])
], MapComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Sean\ikewai\ikewai-dissemination-app\src\main.ts */"./src/main.ts");
